...
const experience = [
  { period: "May 2026 – Present", title: "Technology and Business Systems Innovation Assistant ", place: "Belluz Concrete & Rentals (NOIC)", description: "Selected to work as part of the Northwestern Ontario Innovation Centre’s Youth Tech Impact Program (YTIP) 2026 at Belluz Concrete & Rentals.\n\nKey Responsibilities:\n- Working independently on building an end-to-end automated business intelligence and reporting pipeline for real-time business data.\n- Using PostgreSQL, APIs, Python, Excel, and Power BI to extract, preprocess, transform, and visualize business data.\n- Developing automated dashboards and KPI reporting systems with daily refresh and summary report generation.\n\nGaining hands-on experience in Data Analytics, Data Engineering, workflow automation, and Business Intelligence in a real-world business environment." },
